    ...
    <div>
      <div className="mt-4 w-full">
        <div className="shadow-xl rounded-lg p-4 bg-white">
          ...
          <div className="flex w-full p-2 isolate">
            {/* <div className="w-full">
              <div className="flex mx-auto items-center ml-2">
                <input type="checkbox" className="form-checkbox" checked />
                <span className="ml-2 text-gray-800 text-l font-medium">
                  Concept
                </span>
                <div className="flex mx-2 h-0.5 w-full bg-blue-500 border-dashed"></div>
              </div>
            </div>
            <div className="w-full">
              <div className="flex mx-auto items-center">
                ...
                <div className="flex mx-2 h-0.5 w-full bg-blue-500"></div>
              </div>
            </div>
            <div className="w-full">
              <div className="flex mx-auto items-center">
                <input type="checkbox" />
                <span className="ml-2 text-gray-800 text-l font-medium">Build</span>
                <div className="flex mx-2 h-0.5 w-full bg-blue-500"></div>
              </div>
            </div>
            <div className="w-full">
              ...
              <div className="flex">
                <div className="w-1/4">
                  <div className="relative mb-2">
                    <div className="w-10 h-10 mx-auto bg-blue-600 rounded-full text-lg text-white flex items-center">
                ...
                <div className="w-1/4">
                  <div className="relative mb-2">
                    <div className="absolute flex align-center items-center align-middle content-center w-10/12 transform -translate-x-1/2 translate-y-4">
                      <div className="w-full bg-gray-200 rounded items-center align-middle align-center flex-1">
                        <div className="w-full bg-blue-300 py-1 rounded"></div>
                      </div>
                    </div>
                ...
                <div className="w-1/4">
                  <div className="relative mb-2">
                    <div className="absolute flex align-center items-center align-middle content-center w-10/12 transform -translate-x-1/2 translate-y-4">
                      <div className="w-full bg-gray-200 rounded items-center align-middle align-center flex-1">
                        <div className="w-1/3 bg-blue-300 py-1 rounded"></div>
                      </div>
                    </div>
                  ...
                  <div className="text-xs text-center md:text-base">Build</div>
                </div>
                ...
                <div className="w-1/4">
                  <div className="relative mb-2">
                    <div className="absolute flex align-center items-center align-middle content-center w-10/12 transform -translate-x-1/2 translate-y-4">
                      <div className="w-full bg-gray-200 rounded items-center align-middle align-center flex-1">
                        <div className="w-0 bg-blue-300 py-1 rounded"></div>
                      </div>
                    </div>
                  ...
                  <div className="text-xs text-center md:text-base">Launch</div>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="mt-4 ml-3">
            For more information, explore the project details on the Notion Idea
            Blueprint.
          </div>
          <div className="inline-block ml-3">
            <button className="inline-block px-6 py-2 text-xs font-medium leading-6 text-center text-white uppercase transition bg-blue-600 rounded shadow ripple hover:shadow-lg hover:bg-blue-800 focus:outline-none">
